package com.stormdealers.mcp.tests;
...
import com.stormdealers.mcp.ParseException;
import com.stormdealers.mcp.RenderException;
import com.stormdealers.mcp.VelocityRenderer;
import com.stormdealers.mcp.YAMLToModel;
...
public class YAMLToModelTest {
	...
	public void testProcessProjectDeclaration() throws FileNotFoundException, ParseException, RenderException {
		...
		ProjectObject po = y.process("src/test/com/stormdealers/mcp/tests/sample.model");
